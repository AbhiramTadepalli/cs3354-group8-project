...
const EditApplication = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="text-4xl font-bold ml-6">Edit Application</div>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-10"> 
          <div className="box flex flex-row space-x-6">
            ...
            <div className="flex flex-col space-y-6 w-1/2">
              ...
              {/*Lab Details Box */}
              <div className="bg-orange-100 p-6 rounded-lg">
                <EditableText label="Hours" text=" 1" onSave={(int) => console.log("Hours:", int)} />
                ...
                <EditableText label="Contact Info" text="(123) - 456 - 7890" onSave={(int) => console.log("Contact Info:", int)} />

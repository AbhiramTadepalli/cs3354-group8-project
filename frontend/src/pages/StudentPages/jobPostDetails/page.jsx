...
const JobPostingDetails = () => {
  ...
  const handleApply = () => {
    navigate(`/applyToPosition/${jobId}`);
    console.log(`Navigating to /applyToPosition/${jobId}`);
  };
      ...
      try {
        ...
        if (foundJob) {
          ...
          if (foundJob.professor_id) {
            const professorData = await fetchProfessorById(
              foundJob.professor_id
            );
            if (professorData) {
          ...
          throw new Error(
            `Job with ID ${jobId} not found in the list of valid jobs`
          );
        }
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="bg-gray-200 p-6 rounded-md mb-6">
              ...
              <p className="mb-6">
                {job.job_description || "This position is about....."}
              </p>
          ...
          <div className="md:w-96">
            ...
            <button
              onClick={handleApply}
              className="w-full py-4 bg-orange_clr text-xl font-semibold rounded text-center mt-6 hover:bg-orange-400 transition-colors"
            >
              Apply Now
            </button>
          </div>
